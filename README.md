...
<div align="center" style="background: linear-gradient(to right, #0f2027, #203a43, #2c5364); padding: 20px; border-radius: 10px; margin: 20px 0;">
  <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="40px">  
  <h3 style="color: white;">Full-Stack Developer | AI/ML Innovator | Tech Explorer</h3>
</div>
